...
- (void)showOnCompletion:(void (^ __nullable)(void))completion {
    ...
    [self showFromController:YBIBGetTopController() completion:completion];
}

- (void)showFromController:(UIViewController *)fromController completion:(void (^ __nullable)(void))completion {
    ...
    [fromController presentViewController:self animated:YES completion:completion];
}

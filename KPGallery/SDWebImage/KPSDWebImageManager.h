...
#import "KPSDWebImageOperation.h"
#import "KPSDWebImageDownloader.h"
#import "KPSDImageCache.h"

typedef NS_OPTIONS(NSUInteger, KPSDWebImageOptions) {
    /**
...
typedef void(^KPSDExternalCompletionBlock)(UIImage * _Nullable image, NSError * _Nullable error, KPSDImageCacheType cacheType, NSURL * _Nullable imageURL);

typedef void(^KPSDInternalCompletionBlock)(UIImage * _Nullable image, NSData * _Nullable data, NSError * _Nullable error, KPSDImageCacheType cacheType, BOOL finished, NSURL * _Nullable imageURL);

typedef NSString * _Nullable(^KPSDWebImageCacheKeyFilterBlock)(NSURL * _Nullable url);

typedef NSData * _Nullable(^KPSDWebImageCacheSerializerBlock)(UIImage * _Nonnull image, NSData * _Nullable data, NSURL * _Nullable imageURL);


@class KPSDWebImageManager;

@protocol KPSDWebImageManagerDelegate <NSObject>
 ...
 */
- (BOOL)imageManager:(nonnull KPSDWebImageManager *)imageManager shouldDownloadImageForURL:(nullable NSURL *)imageURL;
 ...
 */
- (BOOL)imageManager:(nonnull KPSDWebImageManager *)imageManager shouldBlockFailedURL:(nonnull NSURL *)imageURL withError:(nonnull NSError *)error;
 ...
 */
- (nullable UIImage *)imageManager:(nonnull KPSDWebImageManager *)imageManager transformDownloadedImage:(nullable UIImage *)image withURL:(nullable NSURL *)imageURL;
 ...
 * @endcode
 */
@interface KPSDWebImageManager : NSObject

@property (weak, nonatomic, nullable) id <KPSDWebImageManagerDelegate> delegate;

@property (strong, nonatomic, readonly, nullable) KPSDImageCache *imageCache;
@property (strong, nonatomic, readonly, nullable) KPSDWebImageDownloader *imageDownloader;
 ...
 * @endcode
 */
@property (nonatomic, copy, nullable) KPSDWebImageCacheKeyFilterBlock cacheKeyFilter;
 ...
 * @code
 SDWebImageManager.sharedManager.cacheKeyFilter = ^NSData * _Nullable(UIImage * _Nonnull image, NSData * _Nullable data, NSURL * _Nullable imageURL) {
    SDImageFormat format = [NSData kpsd_imageFormatForImageData:data];
    switch (format) {
 ...
 */
@property (nonatomic, copy, nullable) KPSDWebImageCacheSerializerBlock cacheSerializer;
 ...
 */
- (nonnull instancetype)initWithCache:(nonnull KPSDImageCache *)cache downloader:(nonnull KPSDWebImageDownloader *)downloader NS_DESIGNATED_INITIALIZER;
 ...
 */
- (nullable id <KPSDWebImageOperation>)loadImageWithURL:(nullable NSURL *)url

 ...
 */
FOUNDATION_EXPORT NSString * _Nonnull const KPSDWebImageCoderScaleDownLargeImagesKey;
 ...
 */
CG_EXTERN CGColorSpaceRef _Nonnull KPSDCGColorSpaceGetDeviceRGB(void);
 ...
 */
CG_EXTERN BOOL KPSDCGImageRefContainsAlpha(_Nullable CGImageRef imageRef);
 ...
 */
@protocol KPSDWebImageCoder <NSObject>
 ...
 */
- (nullable NSData *)encodedDataWithImage:(nullable UIImage *)image format:(KPSDImageFormat)format;
...
/**
 ...
 @note Pay attention that these methods are not called from main queue.
 */
@protocol KPSDWebImageProgressiveCoder <KPSDWebImageCoder>

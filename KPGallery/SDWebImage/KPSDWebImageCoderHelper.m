...
@implementation KPSDWebImageCoderHelper

+ (UIImage *)animatedImageWithFrames:(NSArray<KPSDWebImageFrame *> *)frames {
    ...
    [frames enumerateObjectsUsingBlock:^(KPSDWebImageFrame * _Nonnull frame, NSUInteger idx, BOOL * _Nonnull stop) {
...
+ (NSArray<KPSDWebImageFrame *> *)framesFromAnimatedImage:(UIImage *)animatedImage {
    if (!animatedImage) {
        return nil;
    }
    ...
    [animatedImages enumerateObjectsUsingBlock:^(UIImage * _Nonnull image, NSUInteger idx, BOOL * _Nonnull stop) {
        ...
        if ([image isEqual:previousImage]) {
            ...
            KPSDWebImageFrame *frame = [KPSDWebImageFrame frameWithImage:previousImage duration:avgDuration * repeatCount];

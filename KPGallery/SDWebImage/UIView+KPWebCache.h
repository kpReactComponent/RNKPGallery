 ...
 */
FOUNDATION_EXPORT NSString * _Nonnull const KPSDWebImageInternalSetImageGroupKey;
/**
 A SDWebImageManager instance to control the image download and cache process using in UIImageView+WebCache category and likes. If not provided, use the shared manager (SDWebImageManager)
 */
FOUNDATION_EXPORT NSString * _Nonnull const KPSDWebImageExternalCustomManagerKey;
/**
 The value specify that the image progress unit count cannot be determined because the progressBlock is not been called.
 */
FOUNDATION_EXPORT const int64_t KPSDWebImageProgressUnitCountUnknown; /* 1LL */

typedef void(^SDSetImageBlock)(UIImage * _Nullable image, NSData * _Nullable imageData);

@interface UIView (KPWebCache)
 ...
 */
@property (nonatomic, strong, null_resettable) NSProgress *kpsd_imageProgress;
 ...
 */
@property (nonatomic, strong, nullable) KPSDWebImageTransition *kpsd_imageTransition;

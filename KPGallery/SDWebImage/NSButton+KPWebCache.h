 ...
 */
- (void)kpsd_setImageWithURL:(nullable NSURL *)url NS_REFINED_FOR_SWIFT;
 ...
 * @see kpsd_setImageWithURL:placeholderImage:options:
 */
 ...
 */
- (nullable NSURL *)kpsd_currentAlternateImageURL;
 ...
 */
- (void)kpsd_setAlternateImageWithURL:(nullable NSURL *)url NS_REFINED_FOR_SWIFT;
 ...
 * @see kpsd_setAlternateImageWithURL:placeholderImage:options:
 */

...
@interface KPSDWebImageCoderHelper : NSObject
 ...
 */
+ (UIImage * _Nullable)animatedImageWithFrames:(NSArray<KPSDWebImageFrame *> * _Nullable)frames;
 ...
 */
+ (NSArray<KPSDWebImageFrame *> * _Nullable)framesFromAnimatedImage:(UIImage * _Nullable)animatedImage;
